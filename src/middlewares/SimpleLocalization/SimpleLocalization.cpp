...
SimpleLocalization::SimpleLocalization(MotorSpeed* leftMotorSpeed, MotorSpeed* rightMotorSpeed, double wheelDistance, double wheelRadius):
...
void SimpleLocalization::start() {
    _thread = make_unique<Thread>(SIMPLELOCALIZATION_THREAD_PRIORITY, SIMPLELOCALIZATION_THREAD_STACK_SIZE, nullptr, SIMPLELOCALIZATION_THREAD_NAME);
