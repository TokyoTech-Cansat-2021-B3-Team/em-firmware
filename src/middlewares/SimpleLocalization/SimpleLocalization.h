...
#define SIMPLELOCALIZATION_THREAD_PRIORITY osPriorityHigh
#define SIMPLELOCALIZATION_THREAD_STACK_SIZE 1024
#define SIMPLELOCALIZATION_THREAD_NAME "SIMPLELOCALIZATION"

#define SIMPLELOCALIZATION_PERIOD 200ms
#define ODOMETRY_PERIOD SIMPLELOCALIZATION_PERIOD

class SimpleLocalization{
public:
    explicit SimpleLocalization(MotorSpeed* leftMotorSpeed, MotorSpeed* rightMotorSpeed, double wheelDistance, double wheelRadius);
    void start();
    void stop();
    double x();
    double y();
